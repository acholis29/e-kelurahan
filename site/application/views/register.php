...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/pages/css/register.css" rel="stylesheet" type="text/css" />
    ...
    <body class="register">
        ...
        <div class="content">
            ...
            <!-- BEGIN REGISTRATION FORM -->
                <?php
                    $attributes = array('class' => 'register-form', 'id' => 'frm_register');
                    echo form_open('register/simpan',$attributes);
                    ?>
        ...
        <div class="copyright"> <?php echo "Copyright &copy; diptasoft 2002 - " . date("Y"); ?> </div>
        <!--[if lt IE 9]>
