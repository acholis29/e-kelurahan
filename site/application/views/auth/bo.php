            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-5 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
						...
						?>
						    <input type="hidden" name="grp" value="bo"/>
                            ...
                            <?php 
                                $msgerr = array('The login information entered was not correct. Please try re-entering your username and password. If you are unsure of your login information');

                                if (isset($_REQUEST['err'])) {
                                    if($_GET['err'] !==NULL){
                                        echo '<div class="alert alert-danger"><button class="close" data-close="alert"></button><span>'.$msgerr[0]. '</span></div>';
                                    };
                                };
                            ?>
                            <div class="row">
...
<script>
    $(document).ready(function () {
        $('.login-bg').backstretch([
                ...
                "/assets/pages/img/login/bg-login2.jpg",
                "/assets/pages/img/login/bg-login1.jpg"
                ], {
                    fade: 1000,
                    duration: 8000
                }
