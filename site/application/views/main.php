...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #5 | Coming Soon</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 coming-soon-content">
                    <h1><span style="font-size: 0.7em; color:#ffd800; ">Destination Management Company </span>(DMC)</h1>
            ...
            <!--/end row-->
            <div class="row">
                <div class="col-md-12 coming-soon-footer"> <?php echo "Copyright &copy; diptasoft 2002 - " . date("Y"); ?> </div>
            </div>
        </div>
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script src="../assets/pages/scripts/coming-soon.js" type="text/javascript"></script>
